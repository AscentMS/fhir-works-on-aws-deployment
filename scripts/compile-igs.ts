...
import { SearchImplementationGuides } from '@ascentms/fhir-works-on-aws-search-es';
import { RoutingImplementationGuides } from '@ascentms/fhir-works-on-aws-routing/lib/implementationGuides';
